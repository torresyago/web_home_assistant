...
const dict = {
  es: {
    ...
    'security.certSerialsHint': 'Números de serie de certificado cliente (mTLS) con acceso a la app, con su rol (Administrador o Usuario). Los certificados ya existentes son Administrador por defecto.',
  ...
  en: {
    ...
    'security.certSerialsHint': 'Client certificate (mTLS) serial numbers allowed to access the app, with their role (Admin or User). Existing certificates default to Admin.',
